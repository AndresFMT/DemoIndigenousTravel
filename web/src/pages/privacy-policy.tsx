    ...
    <Suspense fallback="Loading...">
      <Page title={'Privacy Policy'}>
        ...
        <Container>
          ...
          <p>Indigenous Tourism Manitoba operates the https://www.indigenoustourismmanitoba.ca website, which provides the SERVICE.</p>

          <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the Indigenous Tourism Manitoba website.</p>

          <p>If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.</p>

          <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at https://www.indigenoustourismmanitoba.ca, unless otherwise defined in this Privacy Policy.</p>
